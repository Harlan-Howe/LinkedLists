...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.swordItem: InventoryItem = InventoryItem(item_name="sword",
                                                      item_type=InventoryType.MEELEE,
                                                      item_power=5)
        self.wandItem: InventoryItem = InventoryItem(item_name="wand",
                                                     item_type=InventoryType.MAGIC,
                                                     item_power=3)
        self.poulticeItem: InventoryItem = InventoryItem(item_name="poultice",
                                                         item_type=InventoryType.HEALING,
                                                         item_power=2)
        self.clubItem: InventoryItem = InventoryItem(item_name="club",
                                                     item_type=InventoryType.MEELEE,
                                                     item_power=2)
        self.daggerItem: InventoryItem = InventoryItem(item_name="dagger",
                                                       item_type=InventoryType.MEELEE,
                                                       item_power=3)
        self.potionItem: InventoryItem = InventoryItem(item_name="potion",
                                                       item_type=InventoryType.MAGIC,
                                                       item_power=2)
