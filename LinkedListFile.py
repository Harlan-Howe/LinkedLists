...
class LL_Node(Generic[T]):
    def __init__(self, value: T = None, next_node: "LL_Node[T]" = None):
...
class LinkedList(Generic[T]):
    ...
    def item_at_index(self, index: int) -> T:
        ...
        """
        # ------------------------------
        # TODO: You write this one - I suggest you make use of self.pointers_for_index, which I wrote for you just
        #  before this one.
